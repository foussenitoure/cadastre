...
from .utils import unique_post_id_generator
...
def pre_save_post_id(instance, sender, *args, **kwargs):
    if not instance.code_post:
            instance.code_post = unique_post_id_generator(instance)

pre_save.connect(pre_save_post_id, sender=Post)
